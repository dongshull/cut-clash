<template>
  <div class="row g-4 custom-div">
    <div class="col-12 col-lg-12 pt-4 pt-lg-0">
      <div class="tab-content p-0 glass-effect"> <!-- 毛玻璃效果 -->
        <div class="tab-pane fade show active">
          <div class="card mb-4 glass-effect"> <!-- 毛玻璃效果 -->
            <div class="card-body">
  ...
  <!-- 弹窗结构 -->
  <dialog id="errorDialog" ref="errorDialog" class="glass-effect"> <!-- 毛玻璃效果 -->
    <div>
      <p>{{ dialogMessage }}</p>
      <button @click="closeDialog" class="btn btn-danger">关闭</button> <!-- 修改按钮样式 -->
    </div>
  </dialog>
</template>
